...
- **Waiting on Adedamola (⭐ in TODO.md = send Shalom Park the two kickoff messages, 10 min):** the **warranted facts sheet is the hard blocker on the paid build**. Then — 🔴 CAC filing (blocks Meta verification → App Review → automation on their accounts) · VPS + domain + ~₦25k LLM credits · Meta Business Suite link · site visit + title-document sighting · 10 prospect names.
