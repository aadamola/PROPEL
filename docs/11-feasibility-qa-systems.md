...
| Rebrand "PROPEL AI", propelai.com.ng | **Rejected — no brand fork.** Brand stays Propel (@getpropel.tech, getpropel.tech); the automation suite is the **Propel Systems** product line. | Two brands at week zero = split equity in both. The AI story is a product line, not a new company. |
